...
def get_all_plates():
    ...
    try:
        ...
        def evenodd(segment):
            try:
                number = int(segment)  # Convert to integer
                return 1 if number % 2 == 0 else 0  # Even = True, Odd = 0
            except ValueError:
        ...
        for row in plates:
            ...
            if predicted_string:
                ...
                if len(parts) >= 3:  # Ensure there are enough parts
                    ...
                    evenodd_result = evenodd(segment)  # Check even/odd
    ...
    try:
        ...
        for row in penalties:
            ...
            penalties_list.append({
                ...
                "evenodd": evenodd(predicted_string[7]) if predicted_string and len(predicted_string) > 7 else None,
                "penaltytype": row[2],
                "location": row[3],
                "datetime": row[4],
